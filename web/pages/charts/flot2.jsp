        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li><a href="../../AllDev.do"><i class="fa fa-circle-o text-red"></i> <span>设备维护</span></a>
                </li>
...
<script>
    $(function () {
        ...
        <% BuildingIO buildingio = new BuildingIO();
          int[][]num = buildingio.EachHourBuilding(building);
//          num[1][0]=100;
          %>
        var sin = [], cos = []
        ...
        //0进 1出
        <% int[][]mouthnum = buildingio.EachMonthBuilding(building);%>
