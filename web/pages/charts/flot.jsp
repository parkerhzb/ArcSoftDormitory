      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../forms/student_select.jsp"><i class="fa fa-circle-o"></i> 查看所有学生信息</a></li>
            <li><a href="../forms/student_add.jsp"><i class="fa fa-circle-o"></i> 增加学生信息</a></li>
            <li><a href="../forms/student_update.jsp"><i class="fa fa-circle-o"></i> 修改学生信息</a></li>
            <li><a href="../forms/student_delete.jsp"><i class="fa fa-circle-o"></i> 删除学生信息</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../forms/custodian_select.jsp"><i class="fa fa-circle-o"></i> 查看所有宿管信息</a></li>
            <li><a href="../forms/custodian_add.jsp"><i class="fa fa-circle-o"></i> 增加宿管信息</a></li>
            <li><a href="../forms/custodian_update.jsp"><i class="fa fa-circle-o"></i> 修改宿管信息</a></li>
            <li><a href="../forms/custodian_delete.jsp"><i class="fa fa-circle-o"></i> 删除宿管信息</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../forms/device_add.jsp"><i class="fa fa-circle-o"></i> 增加设备信息</a></li>
            <li><a href="../forms/device_update.jsp"><i class="fa fa-circle-o"></i> 修改设备信息</a></li>
            <li><a href="../forms/device_delete.jsp"><i class="fa fa-circle-o"></i> 删除设备信息</a></li>
          </ul>
        </li>

        <li class="header">代办</li>
        <li><a href="../forms/checkDevice.jsp"><i class="fa fa-circle-o text-red"></i> <span>设备维护</span></a></li>
  ...
  $(function () {
    ...
    var bar_data = {
      data : [['一月', 10], ['二月', 8], ['三月', 4], ['四月', 13], ['五月', 17], ['六月', 9],
        ['七月', 10], ['八月', 8], ['九月', 4], ['十月', 13], ['十一月', 17], ['十二月', 9]],
      color: '#3c8dbc'
    }
