            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="student_select.jsp"><i class="fa fa-circle-o"></i> 查看所有学生信息</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="custodian_select.jsp"><i class="fa fa-circle-o"></i> 查看所有宿管信息</a></li>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请登记访客信息</h3>
                </div>

                <div class="box-body">
                    <form method="post" action="../../AddVisitor.do" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>访客学号或身份证：</label>
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-edit"></i>
                                </div>
                                <input name="Id" id="Id" type="text" class="form-control" data-inputmask="'alias': ''" data-mask>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="Name" id="Name" type="text" class="form-control" data-inputmask="'alias': ''" data-mask>
                            </div>
                            <!-- /.input group -->
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="Building" id="Building" type="text" class="form-control" placeholder="例：西13">
                            </div>
                            <!-- /.input group -->
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="Intention" id="Intention" class="form-control" rows="3" maxlength="100" placeholder="（不超过100字）"></textarea>
                                <%--<input name="Intention" id="Intention" type="text" class="form-control">--%>
                            </div>
                            <!-- /.input group -->
                        </div>
                        ...
                        <!-- Main_id邀请者的学号或宿管号 -->
                        <div class="form-group">
                            <label>邀请者的学号或宿管号：</label>

                            <div class="input-group">
                                <div class="input-group-addon">
                                    <i class="fa fa-edit"></i>
                                </div>
                                <input name="Main_id" id="Main_id" type="text" class="form-control">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
