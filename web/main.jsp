                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#" class="btn btn-default btn-flat">重新登录</a>
                                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="pages/forms/student_add.jsp"><i class="fa fa-circle-o"></i> 增加学生信息</a></li>
                        <li><a href="pages/forms/student_update.jsp"><i class="fa fa-circle-o"></i> 修改学生信息</a></li>
                        <li><a href="pages/forms/student_delete.jsp"><i class="fa fa-circle-o"></i> 删除学生信息</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="pages/forms/custodian_add.jsp"><i class="fa fa-circle-o"></i> 增加宿管信息</a></li>
                        <li><a href="pages/forms/custodian_update.jsp"><i class="fa fa-circle-o"></i> 修改宿管信息</a></li>
                        <li><a href="pages/forms/custodian_delete.jsp"><i class="fa fa-circle-o"></i> 删除宿管信息</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/forms/device_add.jsp"><i class="fa fa-circle-o"></i> 增加设备信息</a></li>
                        <li><a href="pages/forms/device_update.jsp"><i class="fa fa-circle-o"></i> 修改设备信息</a></li>
                        <li><a href="pages/forms/device_delete.jsp"><i class="fa fa-circle-o"></i> 删除设备信息</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-left">西十三宿管</span>
                                        ...
                                        <div class="direct-chat-msg right">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-right">西十宿管</span>
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">最新出入人员情况</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tr>
                                        ...
                                        <td>2019.11.02 12：30</td>
                                        <td><span class="label label-success">进寝室</span></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>2019.11.02 12：30</td>
                                        <td><span class="label label-danger">出寝室</span></td>
                                        <td>
