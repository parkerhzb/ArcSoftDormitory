  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/forms2/visitor_add.jsp">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/forms2/student_add.jsp"><i class="fa fa-circle-o"></i> 增加学生信息</a></li>
            <li><a href="pages/forms2/student_update.jsp"><i class="fa fa-circle-o"></i> 修改学生信息</a></li>
            <li><a href="pages/forms2/student_delete.jsp"><i class="fa fa-circle-o"></i> 删除学生信息</a></li>
          </ul>
        </li>
