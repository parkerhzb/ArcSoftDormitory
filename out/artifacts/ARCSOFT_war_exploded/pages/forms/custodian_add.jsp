        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">请输入宿管信息</h3>
                </div>

                    <div class="box-body">
                        <form method="post" action="../../AddCustodian.do" enctype="multipart/form-data">
                        <!-- Date dd/mm/yyyy -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="Gender" id="Gender" type="text" class="form-control" data-inputmask='"mask": "男/女"' data-mask>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        ...
                        <!-- 上传照片 -->
                        <div class="form-group">
                            <label for="CusPhoto">上传照片：</label>
                            <input type="file" name="CusPhoto" id="CusPhoto" onchange="changepic(this)" accept="image/jpg,image/jpeg,image/png,image/PNG">
                            ...
                            <script>
                                function changepic() {
                                    ...
                                    f = document.getElementById('CusPhoto').files[0];
