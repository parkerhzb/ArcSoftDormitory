    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <form method="post" action="../../ModifyCustodian.do">
                    <div class="box-body">
                        <!-- Date dd/mm/yyyy -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="Gender" id="Gender" type="text" class="form-control" data-inputmask='"mask": ""' data-mask>
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
