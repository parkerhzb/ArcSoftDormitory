...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <%
            request.setAttribute("identity","super_admin");
        %>

        <!-- Main content -->
        <section class="content">
            <%
                String msg=(String)session.getAttribute("mess");
                System.out.println(msg);
                if(msg!=null){
            %>
            <div id="alert" class="alert-success"><%=msg%></div>
            <%}%>
            <!-- Default box -->
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <div class="box-body">
                        <form method="post" action="../../AddStudent.do" enctype="multipart/form-data">
                        <!-- Date dd/mm/yyyy -->
