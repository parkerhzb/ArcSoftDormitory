...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- search form -->
            <form action="AddVisitor.do" method="get" class="sidebar-form">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form method="post" action="../../AddVisitor.do">
    ...
    <%--type: 1,--%>
    <%--title:'访客二维码',--%>
    <%--content: '<img src="../../QR/visitor_QR.png">'--%>
    <%--});--%>
    <%--</script>--%>
    <%--<%}--%>
        <%--session.setAttribute("path",null);--%>
